...
class HexGridWidget extends ConsumerStatefulWidget {
  final Level level;
  ...
  @override
  ConsumerState<HexGridWidget> createState() => _HexGridWidgetState();
}

class _HexGridWidgetState extends ConsumerState<HexGridWidget> {
  ...
  /// Previous visited cells count for detecting path reset
